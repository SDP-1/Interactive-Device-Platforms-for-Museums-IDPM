...
class AiPersonaChatPage extends StatefulWidget {
  const AiPersonaChatPage({required this.persona, super.key});

  final Persona persona;

  @override
  State<AiPersonaChatPage> createState() => _AiPersonaChatPageState();
}

class _AiPersonaChatPageState extends State<AiPersonaChatPage> {
                      ...
                      child: Row(
                        children: [
                          GestureDetector(
                            ...
                            child: const Icon(Icons.mic, color: Colors.black45),
                          ),
